...
import { createApplication } from '../lib/supabaseQueries';
...
const PartnershipPage = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      toast.success('Application submitted successfully! We will review it within 5 business days.');
                ...
                <div className="mt-8 flex justify-between">
                  ...
                  {currentStep < 3 ? (
                    ...
                    <button
                      ...
                      className="bg-energy-orange hover:bg-orange-600 text-white px-8 py-3 rounded-lg font-semibold transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center space-x-2"
                    >
                      {isSubmitting ? (
                        <>
